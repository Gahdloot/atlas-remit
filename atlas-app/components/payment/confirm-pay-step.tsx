...
export function ConfirmPayStep({
  paymentData,
  prevStep,
  currentStep,
  nextStep,
  ...
  const [createPaymentRequest, { isLoading: isCreatingPayment }] =
    useCreatePaymentRequestMutation();
  const [getVirtualAccount, { isLoading: isGeneratingAccount }] =
    useGetOneTimeVirtualAccountMutation();
  ...
  const handlePayNow = async () => {
    try {
      ...
      const accountResult = await getVirtualAccount(
        virtualAccountData
      ).unwrap();
        ...
        <div className="space-y-2 bg-white p-4 mt-4 md:mt-6">
          ...
          {isProcessing && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-blue-800 text-sm flex items-center">
                <span className="animate-spin inline-block rounded-full h-4 w-4 border-b-2 border-blue-800 mr-2"></span>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <p className="text-amber-800 text-sm">
              Rate will be locked for{" "}
              <span className="font-semibold">24 hours</span> at{" "}
              <span className="font-semibold">1,510.17 NGN</span> after quote is
              generated
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="border-b border-gray-100 space-y-1 py-3">
                ...
                <p className="text-gray-600">Bank Transfer in Nigerian Naira</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="border-b border-gray-100 space-y-1 py-3">
                ...
                <p className="text-gray-600">
                  {paymentData.payerFirstName} {paymentData.payerLastName || ""}
                </p>
              </div>
              <div className="border-b border-gray-100 space-y-1 py-3">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="border-b border-gray-100 space-y-1 py-3">
                ...
                <p className="text-gray-600">
                  {paymentData.studentExpectedYearOfCompletion || ""}
                </p>
              </div>
              <div className="border-b border-gray-100 space-y-1 py-3">
                <p className="text-muted-foreground">Program of study</p>
                <p className="text-gray-600">
                  {paymentData.studentProgramStudied || ""}
                </p>
              </div>
              <div className="border-b border-gray-100 space-y-1 py-3">
                <p className="text-muted-foreground">Full name</p>
                <p className="text-gray-600">
                  {paymentData.studentFirstName}{" "}
                  {paymentData.studentLastName || ""}
                </p>
              </div>
              <div className="border-b border-gray-100 space-y-1 py-3">
              ...
              <div className="border-b border-gray-100 space-y-1 py-3">
                ...
                <p className="text-gray-600">
                  {paymentData.studentPhoneNumber || ""}
                </p>
              </div>
              <div className="border-b border-gray-100 space-y-1 py-3">
