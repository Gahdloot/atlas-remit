...
const currencies = [
  { code: "USD", name: "United States Dollar - USD", flag: "🇺🇸" },
  { code: "EUR", name: "European Euro - EUR", flag: "🇪🇺" },
  { code: "CAD", name: "Canadian Dollar - CAD", flag: "🇨🇦" },
...
const NGN_RATE = 510 // Dummy NGN rate for example
...
export function AmountAndRateStep({
  ...
  const convertedAmount =
    amount && !isNaN(Number(amount))
      ? (parseFloat(amount) * (NGN_RATE / (exchangeRates[selectedCurrency] || 1))).toFixed(2)
      : ""
  ...
  const handleNext = () => {
    ...
    // update payment data with amount & currency
  ...
  return (
    <div className="min-h-screen  p-4 ">
      ...
      />
      <div className="text-[#939b98] bg-gray-50 rounded-2xl p-4">
        {/* Header */}
        <div className="flex items-center justify-between mb-8 pt-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold">NGN/CAD</span>
          </div>
          <div className="text-xl font-semibold text-lime-500">₦1,510.17</div>
        </div>
