      ...
      <div className="relative z-10 flex items-center px-6 lg:px-12 py-12 lg:py-24 min-h-[calc(100vh-200px)] max-w-7xl mx-auto ">
        <div className="max-w-2xl space-y-8 mt-12">
          ...
          <div className="relative font-sans">
            <h1 className="relative text-5xl font-poppins lg:text-7xl font-bold leading-tight bg-gradient-to-r from-lime-100 via-lime-200 to-green-300 bg-clip-text text-transparent">
              Send tuition money{" "}
              <span className="">
