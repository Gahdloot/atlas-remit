    ...
    return (
      <div className="relative w-full max-w-full">
        ...
        >
          ...
          >
            <img
              ...
              className="w-5 h-5 object-cover [clip-path:circle()]"
            />
            <svg
        ...
        {showDropdown && (
          <div
            ref={dropdownRef}
            className="absolute z-50 bottom-full mb-1 w-[50%] max-h-100 overflow-y-auto bg-white border border-gray-300 rounded-md shadow-lg"
          >
            ...
            <VirtualizedList
              ...
              renderItem={(country) => (
                <button
                  key={country.code}
                  type="button"
                  className="flex items-center w-full px-3 py-2 border-b border-gray-200 text-gray-500 hover:bg-gray-100 gap-2"
                  onClick={() => {
