...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex items-center justify-between gap-2 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default select-none items-center gap-2 rounded-sm py-2 pl-3 pr-8 text-sm text-gray-900",
        "focus:bg-lime-100 focus:text-lime-900 hover:bg-lime-50 transition-colors",
