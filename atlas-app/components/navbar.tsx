          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-white rounded-lg shadow-lg border border-gray-200 p-2">
                <DropdownMenuItem className="hover:bg-gray-50 rounded p-2 cursor-pointer">Help Center</DropdownMenuItem>
                <DropdownMenuItem className="hover:bg-gray-50 rounded p-2 cursor-pointer">Contact Us</DropdownMenuItem>
                <DropdownMenuItem className="hover:bg-gray-50 rounded p-2 cursor-pointer">Live Chat</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
